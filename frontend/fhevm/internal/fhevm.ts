...
export const createFhevmInstance = async (parameters: {
  ...
  const config: FhevmInstanceConfig = {
    verifyingContractAddressDecryption:
      relayerSDK.SepoliaConfig.verifyingContractAddressDecryption as string,
    verifyingContractAddressInputVerification:
      relayerSDK.SepoliaConfig
        .verifyingContractAddressInputVerification as string,
    kmsContractAddress: relayerSDK.SepoliaConfig.kmsContractAddress as string,
    inputVerifierContractAddress:
      relayerSDK.SepoliaConfig.inputVerifierContractAddress as string,
    aclContractAddress: relayerSDK.SepoliaConfig.aclContractAddress as string,
    gatewayChainId: relayerSDK.SepoliaConfig.gatewayChainId as number,
    chainId: (relayerSDK.SepoliaConfig as any).chainId,
    relayerUrl: (relayerSDK.SepoliaConfig as any).relayerUrl,
